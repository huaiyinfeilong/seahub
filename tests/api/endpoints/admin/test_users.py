...
class AdminUsersTest(BaseTestCase):
    ...
    def test_get_users(self):
        ...
        assert 'email' in json_resp['users'][0]
        assert 'name' in json_resp['users'][0]
        assert 'contact_email' in json_resp['users'][0]
        assert 'is_staff' in json_resp['users'][0]
        assert 'is_active' in json_resp['users'][0]
        assert 'create_time' in json_resp['users'][0]
        assert 'quota_total' in json_resp['users'][0]
        assert 'quota_usage' in json_resp['users'][0]
