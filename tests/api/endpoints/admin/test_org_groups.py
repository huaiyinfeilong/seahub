...
class OrgGroupsTest(BaseTestCase):
    ...
    def setUp(self):
        ...
        if LOCAL_PRO_DEV_ENV:
            ...
            self.org_groups_url = reverse('api-v2.1-admin-org-groups',
                    args=[self.org_id])
    ...
    def test_get_with_invalid_org_id(self):
        ...
        self.login_as(self.admin)
        invalid_org_groups_url = reverse('api-v2.1-admin-org-groups', args=[0])

        resp = self.client.get(invalid_org_groups_url)
